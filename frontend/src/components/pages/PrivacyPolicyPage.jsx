    ...
    <div className="privacy-page">
      <div className="privacy-card">
        ...
        <ul>
          ...
          <li><strong>Application</strong> refers to Akaleta, the software program provided by the Company.</li>
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Akaleta.</li>
          <li><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website, among its many uses.</li>
          <li><strong>Country/State</strong> refers to: Nigeria.</li>
          ...
          <li><strong>Website</strong> refers to Akaleta, accessible from <a href="https://www.akaleta.xyz" target="_blank" rel="noopener noreferrer">https://www.akaleta.xyz</a>.</li>
        ...
        <p>We use this information to provide features of Our Service and to improve and customize Our Service. The information may be uploaded to the Company's servers and/or a Service Provider's server or it may be simply stored on Your device.</p>
        ...
        <ul>
          <li>By email: <a href="mailto:amadiobijanice@gmail.com">amadiobijanice@gmail.com</a></li>
        </ul>
      ...
      <style>{`
        ...
        .privacy-card h2 { margin-top: 24px; margin-bottom: 12px; }
        .privacy-card h3 { margin-top: 18px; margin-bottom: 8px; }
        .privacy-card h4 { margin-top: 16px; margin-bottom: 6px; }
        .privacy-card ul { padding-left: 20px; color: var(--text-secondary); line-height: 1.7; }
        .privacy-card p { color: var(--text-secondary); line-height: 1.7; margin-bottom: 12px; }
        .privacy-card .updated { margin-top: 0; font-size: 0.95rem; color: var(--text-tertiary); }
        .privacy-card a { color: var(--text-primary); text-decoration: underline; }
      `}</style>
    </div>
  );
}
